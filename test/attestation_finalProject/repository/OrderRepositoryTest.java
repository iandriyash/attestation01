...
class OrderRepositoryTest {
    ...
    @Test
    void findAllFiltered_ByStatus_ShouldReturnMatchingOrders() {
        ...
        List<Order> result = orderRepository.findAllFiltered("NEW", null);
    ...
    @Test
    void findAllFiltered_ByPhone_ShouldReturnMatchingOrders() {
        Order order1 = new Order();
        order1.setCustomerName("Иван");
        ...
        List<Order> result = orderRepository.findAllFiltered(null, "+79991234573");
